...
double** jacobi_iteration(double delta,int n_x, int n_y,double *y, double** phi_upd, double** q)
{
...
int main()
{
    ...
    {
        iter_count += 1;
        phi_upd = jacobi_iteration(delta,n_x,n_y,y,phi_upd,q);
    ...
    string file_name = "Poisson_Jacobi_serial" + delta_s+".csv";
